...
var ReactVersion = '19.1.0-experimental-144de20e-20250717';
...
function flushSyncImpl(fn) {
  ...
  const previousUpdatePriority = Internals.p; /* ReactDOMCurrentUpdatePriority */
  ...
  try {
    ...
    Internals.d /* ReactDOMCurrentDispatcher */.f(); /* flushSyncWork */
  }
}
