...
var ReactVersion = '19.1.0-www-classic-144de20e-20250717';

// Re-export dynamic flags from the www version.
var dynamicFeatureFlags = require('ReactFeatureFlags');
var disableDefaultPropsExceptForClasses = dynamicFeatureFlags.disableDefaultPropsExceptForClasses,
  ...
  ownerStackLimit = dynamicFeatureFlags.ownerStackLimit; // On WWW, false is used for a new modern build.
      ...
      Object.defineProperties(lazyType, {
        defaultProps: {
          ...
          set: function (newDefaultProps) {
            console.error('It is not supported to assign `defaultProps` to ' + 'a lazy component import. Either specify them where the component ' + 'is defined, or create a wrapping component around it.');
...
function useEffect(create, createDeps, update, updateDeps, destroy) {
  ...
  var dispatcher = resolveDispatcher();
  if (enableUseEffectCRUDOverload && (typeof update === 'function' || typeof destroy === 'function')) {
    // $FlowFixMe[not-a-function] This is unstable, thus optional
    return dispatcher.useEffect(create, createDeps, update, updateDeps, destroy);
