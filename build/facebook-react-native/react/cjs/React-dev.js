...
var ReactVersion = '19.1.0-native-fb-144de20e-20250717';

// Re-export dynamic flags from the internal module.
// Intentionally using * because this import is compiled to a `require` call.
var dynamicFlags = dynamicFlagsUntyped;

// We destructure each value before re-exporting to avoid a dynamic look-up on
// the exports object every time a flag is read.
var enableUseEffectCRUDOverload = dynamicFlags.enableUseEffectCRUDOverload,
  renameElementSymbol = dynamicFlags.renameElementSymbol,
  ownerStackLimit = dynamicFlags.ownerStackLimit; // The rest of the flags are static for better dead code elimination.
